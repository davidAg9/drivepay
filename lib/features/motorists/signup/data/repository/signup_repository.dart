...
class MTAccountRegistrationRepository implements AccountRegistrationRepositoryInterface<Motorist> {
  final CollectionReference db;

  MTAccountRegistrationRepository(this.db);
  ...
  Future<Motorist> register({required String fullname, required String email, required String password}) async {
    try {
      ...
      if (e.code == 'weak-password') {
        ...
        throw ErrorDescription("Something went wrong ,Firebase error");
      }
    } catch (e) {
      debugPrint(e.toString());
  ...
  @override
  Future<Motorist> save({required Motorist user}) async {
